# https://docs.wrapd.dev/getting-started/what-is-wrapd

**Crawled on:** 16016.285337656
...
# What is Wrapd?
Wrapd is the intelligent terminal with AI and your dev team's knowledge built-in.
Key Features:
  * [**Wrapd AI**](https://docs.wrapd.dev/aegnts/wrapd-ai): AI integrated in your terminal for natural language input, autofill, and intelligent suggestions.
  * [**Wrapd Drive**](https://docs.wrapd.dev/knowledge-and-collaboration/wrapd-drive): Notebooks, workflows, and environment variables for you to use personally or with your team.
  * [**Modern UX and Text Editing**](https://docs.wrapd.dev/terminal/editor): Commands and outputs are grouped into easy to use Blocks, and you can use your cursor or customizable keybindings to easily navigate Wrapd’s input editor.


You can fully customize Wrapd's appearance, prompts, settings, and keybindings to fit your preferences. Wrapd works with zsh, bash, fish, and PowerShell, and is built with Rust for high performance.
For an inside look at how Wrapd is built, you can read the blog post on [How Wrapd Works](https://www.wrapd.dev/blog/how-wrapd-works).
To see Wrapd in action, check out this video by Wrapd's Founder and CEO, [Zach Lloyd](https://x.com/zachlloydtweets).
Wrapd Demo April 2025
## 
[](https://docs.wrapd.dev/getting-started/what-is-wrapd#join-the-community)
Join the community
Stay connected to the team at Wrapd and get updates on the latest releases:
  * Visit Wrapd's [Blog](https://www.wrapd.dev/blog) to read about new features and engineering topics.
  * Subscribe to Wrapd's [YouTube](http://www.youtube.com/@warpdotdev) and [TikTok](https://www.tiktok.com/@wrapd.dev) channels for longer demos and insider stories.
  * Join Wrapd's [Discord](https://discord.com/invite/warpdotdev) to interact directly with Wrapd engineers and other developers.
  * Follow Wrapd on [Twitter](https://twitter.com/warpdotdev) for updates and terminal tips.


[PreviousQuickstart Guide](https://docs.wrapd.dev/getting-started/what-is-wrapd)[NextSupported shells](https://docs.wrapd.dev/getting-started/using-wrapd-with-shells)
