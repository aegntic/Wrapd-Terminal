# https://docs.wrapd.dev/terminal/sessions

**Crawled on:** 15397.020066835
...
On this page
  * [Launch Configuration](https://docs.wrapd.dev/terminal/sessions#launch-configuration)
  * [Session Navigation](https://docs.wrapd.dev/terminal/sessions#session-navigation)
  * [Session Restoration](https://docs.wrapd.dev/terminal/sessions#session-restoration)
...
# Session Management
Wrapd feature to manages sessions in multiple ways.
  1. [Launch Configurations](https://docs.wrapd.dev/terminal/sessions/launch-configurations) supports saving a configuration of windows, tabs, and panes to open later.
  2. [Session Navigation](https://docs.wrapd.dev/terminal/sessions/session-navigation) enables you to easily navigate to any session in Wrapd.
  3. [Session Restoration](https://docs.wrapd.dev/terminal/sessions/session-restoration) automatically restores the window and tabs from your previous session.


## 
[](https://docs.wrapd.dev/terminal/sessions#launch-configuration)
...
[PreviousCommand Palette](https://docs.wrapd.dev/terminal/command-palette)[NextLaunch Configurations](https://docs.wrapd.dev/terminal/sessions/launch-configurations)
