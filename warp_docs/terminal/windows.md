# https://docs.wrapd.dev/terminal/windows

**Crawled on:** 16219.84821581
...
# Window Management
Wrapd's features for Window Management.
  1. [Global Hotkey](https://docs.wrapd.dev/terminal/windows/global-hotkey) is a configurable shortcut that can show/hide a dedicated window or all windows on your chosen desktop regardless of whether the app is focused.
  2. [Tabs](https://docs.wrapd.dev/terminal/windows/tabs) allow you to organize a window into multiple terminal sessions.
  3. [Split Panes](https://docs.wrapd.dev/terminal/windows/split-panes) allows you to divide a Tab into multiple rectangular _panes_ , each of which is a unique terminal session.


## 
[](https://docs.wrapd.dev/terminal/windows#global-hotkey)
Global Hotkey
...
## 
[](https://docs.wrapd.dev/terminal/windows#tabs)
Tabs
Tabs Demo
## 
[](https://docs.wrapd.dev/terminal/windows#split-panes)
Split Panes
Split Panes Demo
[PreviousSession Restoration](https://docs.wrapd.dev/terminal/sessions/session-restoration)[NextGlobal Hotkey](https://docs.wrapd.dev/terminal/windows/global-hotkey)
