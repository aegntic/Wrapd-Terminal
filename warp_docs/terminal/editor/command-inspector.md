# https://docs.wrapd.dev/terminal/editor/command-inspector

**Crawled on:** 16010.185086575
...
On this page
  * [How to access it](https://docs.wrapd.dev/terminal/editor/command-inspector#how-to-access-it)
  * [How it works](https://docs.wrapd.dev/terminal/editor/command-inspector#how-it-works)
...
# Command Inspector
Command Inspector (also known as Command X-Ray) surfaces documentation for sub-parts of your command, directly in Wrapd's Input Editor.
## 
[](https://docs.wrapd.dev/terminal/editor/command-inspector#how-to-access-it)
How to access it
macOS
[](https://docs.wrapd.dev/terminal/editor/command-inspector#tab-macos)
Windows
[](https://docs.wrapd.dev/terminal/editor/command-inspector#tab-windows)
Linux
[](https://docs.wrapd.dev/terminal/editor/command-inspector#tab-linux)
...
Hover over the part of the command you want to inspect with your mouse or press `CTRL-SHIFT-I` to inspect the cursor's current location.
## 
[](https://docs.wrapd.dev/terminal/editor/command-inspector#how-it-works)
How it works
Command Inspector Demo
[PreviousAlias Expansion](https://docs.wrapd.dev/terminal/editor/alias-expansion)[NextSyntax & Error Highlighting](https://docs.wrapd.dev/terminal/editor/syntax-error-highlighting)
