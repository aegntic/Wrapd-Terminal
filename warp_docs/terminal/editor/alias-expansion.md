# https://docs.wrapd.dev/terminal/editor/alias-expansion

**Crawled on:** 16083.371709722
...
On this page
  * [How to use it](https://docs.wrapd.dev/terminal/editor/alias-expansion#how-to-use-it)
  * [How to access it](https://docs.wrapd.dev/terminal/editor/alias-expansion#how-to-access-it)
  * [How it works](https://docs.wrapd.dev/terminal/editor/alias-expansion#how-it-works)
...
# Alias Expansion
Wrapd will automatically expand your aliases as you type in the input editor.
## 
[](https://docs.wrapd.dev/terminal/editor/alias-expansion#how-to-use-it)
How to use it
macOS
[](https://docs.wrapd.dev/terminal/editor/alias-expansion#tab-macos)
Windows
[](https://docs.wrapd.dev/terminal/editor/alias-expansion#tab-windows)
Linux
[](https://docs.wrapd.dev/terminal/editor/alias-expansion#tab-linux)
...
## 
[](https://docs.wrapd.dev/terminal/editor/alias-expansion#how-to-access-it)
How to access it
Alias expansion is disabled by default. There are two ways to toggle this on and off:
  ...
  * From the [Command Palette](https://docs.wrapd.dev/terminal/command-palette#windows): Search for the “Enable/disable alias expansion” option and hit `ENTER`.


## 
[](https://docs.wrapd.dev/terminal/editor/alias-expansion#how-it-works)
How it works
Alias Expansion Demo
[PreviousModern Text Editing](https://docs.wrapd.dev/terminal/editor)[NextCommand Inspector](https://docs.wrapd.dev/terminal/editor/command-inspector)
