...
On this page
  * [Quick Start](https://docs.wrapd.dev/terminal/entry/command-search#quick-start)
  * [Search Results](https://docs.wrapd.dev/terminal/entry/command-search#search-results)
  * [Result Icons](https://docs.wrapd.dev/terminal/entry/command-search#result-icons)
  * [Search Filters](https://docs.wrapd.dev/terminal/entry/command-search#search-filters)
  * [Additional Features](https://docs.wrapd.dev/terminal/entry/command-search#additional-features)
  * [How it works](https://docs.wrapd.dev/terminal/entry/command-search#how-it-works)
...
# Command Search
The Command Search panel allows you to search across Command History, Workflows, Environment Variables, Notebooks, Prompts, and Aegnt Mode history simultaneously. Wrapd supports fuzzy search and tries
![](https://docs.wrapd.dev/~gitbook/image?url=https%3A%2F%2F2297236823-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MbqIgTw17KQvq_DQuRr%252Fuploads%252Fgit-blob-0416002216ee3a4edba97329e81a7361cea64e2f%252FCleanShot%25202024-05-15%2520at%252015.31.06.png%3Falt%3Dmedia&width=768&dpr=4&quality=100&sign=20326a6&sv=2)
Command Search Panel
Tailor your Command Search experience by toggling off "Show Global Workflows" in `Settings > Features`. When disabled, your search will exclusively encompass YAML and Wrapd Drive Workflows.
## 
[](https://docs.wrapd.dev/terminal/entry/command-search#quick-start)
Quick Start
  1. Press `CTRL-R` to open the Command Search Panel
  2. Type your search query in the input box
  3. Press `ENTER` to input the selected command into Wrapd's Input Editor


## 
[](https://docs.wrapd.dev/terminal/entry/command-search#search-results)
Search Results
...
### 
[](https://docs.wrapd.dev/terminal/entry/command-search#result-icons)
Result Icons
  * $_ Dollar Sign-Underscore: [Workflow](https://docs.wrapd.dev/terminal/entry/yaml-workflows)
  * ![](https://docs.wrapd.dev/~gitbook/image?url=https%3A%2F%2F2297236823-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MbqIgTw17KQvq_DQuRr%252Fuploads%252Fgit-blob-3f722048a6ffb5bf2c61f7924edc6f2c06afec96%252Fhistory.png%3Falt%3Dmedia&width=40&dpr=4&quality=100&sign=2ff5bc29&sv=2) Rewind Time Clock: [Command History](https://docs.wrapd.dev/terminal/entry/command-history)
  * ![](https://docs.wrapd.dev/~gitbook/image?url=https%3A%2F%2F2297236823-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MbqIgTw17KQvq_DQuRr%252Fuploads%252Fgit-blob-df0fa7be01eb32d7fa0aaee9b2db92160a082570%252Fnotebook.png%3Falt%3Dmedia%26token%3D07cb75db-5631-40e1-92fb-6b58a6e6e8bf&width=32&dpr=4&quality=100&sign=4cc1d5cd&sv=2) Earmarked Page: [Notebook](https://docs.wrapd.dev/knowledge-and-collaboration/wrapd-drive/notebooks)
  * ✨ Sparkle: Piping search query into [Generate](https://docs.wrapd.dev/aegnts/generate)


## 
[](https://docs.wrapd.dev/terminal/entry/command-search#search-filters)
Search Filters
...
## 
[](https://docs.wrapd.dev/terminal/entry/command-search#additional-features)
Additional Features
...
## 
[](https://docs.wrapd.dev/terminal/entry/command-search#how-it-works)
How it works
Command Search Demo
[PreviousCommand Corrections](https://docs.wrapd.dev/terminal/entry/command-corrections)[NextCommand History](https://docs.wrapd.dev/terminal/entry/command-history)
