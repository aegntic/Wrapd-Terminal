...
On this page
  * [What is it](https://docs.wrapd.dev/terminal/entry/command-corrections#what-is-it)
  * [How to access it](https://docs.wrapd.dev/terminal/entry/command-corrections#how-to-access-it)
  * [How it works](https://docs.wrapd.dev/terminal/entry/command-corrections#how-it-works)
...
## 
[](https://docs.wrapd.dev/terminal/entry/command-corrections#what-is-it)
What is it
This feature was built on top of the open-source project [nvdn/thefuck](https://github.com/nvbn/thefuck). Here are some examples that the Wrapd team usually finds Command Corrections useful for:
  * Misspelled commands
...
## 
[](https://docs.wrapd.dev/terminal/entry/command-corrections#how-to-access-it)
How to access it
...
## 
[](https://docs.wrapd.dev/terminal/entry/command-corrections#how-it-works)
How it works
Command Corrections Demo
#### 
[](https://docs.wrapd.dev/terminal/entry/command-corrections#command-correction-rules)
...
sudo
yarn
[PreviousCommand Entry](https://docs.wrapd.dev/terminal/entry)[NextCommand Search](https://docs.wrapd.dev/terminal/entry/command-search)
