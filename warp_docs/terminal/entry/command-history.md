...
On this page
  * [What is it](https://docs.wrapd.dev/terminal/entry/command-history#what-is-it)
  * [How to access it](https://docs.wrapd.dev/terminal/entry/command-history#how-to-access-it)
  * [How it works](https://docs.wrapd.dev/terminal/entry/command-history#how-it-works)
...
## 
[](https://docs.wrapd.dev/terminal/entry/command-history#what-is-it)
What is it
While running, Wrapd isolates the history of each shell session e.g. if you have two Split Panes open, commands created in one pane do not populate the history of the other. Wrapd combines the history upon closing.
...
## 
[](https://docs.wrapd.dev/terminal/entry/command-history#how-to-access-it)
How to access it
  ...
  * Pressing `CTRL-R` opens the [Command Search](https://docs.wrapd.dev/terminal/entry/command-search) panel and initiates a search of your Command History. To navigate the Command Search panel:
    * Start typing and Wrapd will automatically filter using fuzzy search. Wrapd bolds matching text when filtering with fuzzy search.


## 
[](https://docs.wrapd.dev/terminal/entry/command-history#how-it-works)
How it works
Command History Demo
[PreviousCommand Search](https://docs.wrapd.dev/terminal/entry/command-search)[NextSynchronized Inputs](https://docs.wrapd.dev/terminal/entry/synchronized-inputs)
