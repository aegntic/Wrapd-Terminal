# https://docs.wrapd.dev/terminal/entry/synchronized-inputs

**Crawled on:** 16122.458507859
...
On this page
  * [Synchronized inputs vs. broadcast input](https://docs.wrapd.dev/terminal/entry/synchronized-inputs#synchronized-inputs-vs.-broadcast-input)
  * [How to access it](https://docs.wrapd.dev/terminal/entry/synchronized-inputs#how-to-access-it)
  * [How to use it](https://docs.wrapd.dev/terminal/entry/synchronized-inputs#how-to-use-it)
  * [How it works](https://docs.wrapd.dev/terminal/entry/synchronized-inputs#how-it-works)
...
### 
[](https://docs.wrapd.dev/terminal/entry/synchronized-inputs#synchronized-inputs-vs.-broadcast-input)
Synchronized inputs vs. broadcast input
Synchronized inputs in Wrapd work similarly to “broadcast input” settings in other terminals, but there are some differences.
With Wrapd’s synchronized inputs, whatever command you enter in one session will sync to the other sessions in its entirety. Whereas, "broadcast input" typically allows you to "broadcast" individual keystrokes, which may be more suitable for editing parts of commands.
## 
[](https://docs.wrapd.dev/terminal/entry/synchronized-inputs#how-to-access-it)
How to access it
There are three ways to access controls to synchronize inputs:
  * [Command Palette](https://docs.wrapd.dev/terminal/command-palette) in Wrapd: Search for “synchronize”
  * Mac menus for the Wrapd app: `Edit > Synchronize Input`


## 
[](https://docs.wrapd.dev/terminal/entry/synchronized-inputs#how-to-use-it)
How to use it
macOS
[](https://docs.wrapd.dev/terminal/entry/synchronized-inputs#tab-macos)
Windows
[](https://docs.wrapd.dev/terminal/entry/synchronized-inputs#tab-windows)
Linux
[](https://docs.wrapd.dev/terminal/entry/synchronized-inputs#tab-linux)
...
## 
[](https://docs.wrapd.dev/terminal/entry/synchronized-inputs#how-it-works)
How it works
![Demo showing synchronized inputs across panes and tabs](https://docs.wrapd.dev/~gitbook/image?url=https%3A%2F%2Fgithub.com%2Fwarpdotdev%2Fgitbook%2Fblob%2Fmain%2Fdocs%2F.gitbook%2Fassets%2FSynchronized-Inputs.gif&width=768&dpr=4&quality=100&sign=2df7c93e&sv=2)
Synchronized Inputs Demo
[PreviousCommand History](https://docs.wrapd.dev/terminal/entry/command-history)[NextYAML Workflows](https://docs.wrapd.dev/terminal/entry/yaml-workflows)
