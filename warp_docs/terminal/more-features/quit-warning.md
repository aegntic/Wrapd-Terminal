# https://docs.wrapd.dev/terminal/more-features/quit-warning

**Crawled on:** 16014.415839681
...
On this page
  * [What is it](https://docs.wrapd.dev/terminal/more-features/quit-warning#what-is-it)
  * [How to access it](https://docs.wrapd.dev/terminal/more-features/quit-warning#how-to-access-it)
  * [How it Works](https://docs.wrapd.dev/terminal/more-features/quit-warning#how-it-works)
...
# Quit Warning
Wrapd's quit warning feature is a valuable precaution to prevent unintentional data loss or lost progress on long-running jobs.
## 
[](https://docs.wrapd.dev/terminal/more-features/quit-warning#what-is-it)
What is it
...
## 
[](https://docs.wrapd.dev/terminal/more-features/quit-warning#how-to-access-it)
How to access it
  * Open `Settings > Features > General`, there you can toggle the "Show warning before quitting".
  * You can also toggle the quit warning feature in the [Command Palette](https://docs.wrapd.dev/terminal/command-palette), by searching for `Quit Warning'.
  * If enabled, when you try and close Wrapd you will see a pop-up window with a few options listed below:
    * Yes, quit, which will close all the Wrapds sessions and running processes.
    * Show running processes, which will bring up the [Session Navigation](https://docs.wrapd.dev/terminal/sessions/session-navigation) panel with a filter for running processes.
    * Cancel, which will prevent Wrapd from closing.
    * Don't ask again, which is a box you can check to disable the quit warning feature.


## 
[](https://docs.wrapd.dev/terminal/more-features/quit-warning#how-it-works)
How it Works
Quit Warning Modal Demo
[PreviousSettings Sync (Beta)](https://docs.wrapd.dev/terminal/more-features/settings-sync)[NextURI Scheme](https://docs.wrapd.dev/terminal/more-features/uri-scheme)
