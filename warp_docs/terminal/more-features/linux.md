# https://docs.wrapd.dev/terminal/more-features/linux

**Crawled on:** 16065.973524162
...
On this page
  * [Native Wayland](https://docs.wrapd.dev/terminal/more-features/linux#native-wayland)
  * [Wayland Crash Recovery](https://docs.wrapd.dev/terminal/more-features/linux#wayland-crash-recovery)
...
## 
[](https://docs.wrapd.dev/terminal/more-features/linux#native-wayland)
Native Wayland
Wrapd Wayland support can be enabled in `Settings > Features > System`. Enabling Wayland support may fix issues with blurry text if you have fractional scaling enabled in your window manager.
...
## 
[](https://docs.wrapd.dev/terminal/more-features/linux#wayland-crash-recovery)
Wayland Crash Recovery
When Wayland support is enabled, Wrapd uses a custom crash recovery process to detect any crashes that may occur when using Wayland. If there's a crash, Wrapd will fallback to use X11 to allow you to continue to use the application.
[PreviousURI Scheme](https://docs.wrapd.dev/terminal/more-features/uri-scheme)[NextComparisons](https://docs.wrapd.dev/terminal/comparisons)
