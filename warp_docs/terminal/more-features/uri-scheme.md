# https://docs.wrapd.dev/terminal/more-features/uri-scheme

**Crawled on:** 16055.271905757
...
On this page
  * [How to use it](https://docs.wrapd.dev/terminal/more-features/uri-scheme#how-to-use-it)
  * [How it works](https://docs.wrapd.dev/terminal/more-features/uri-scheme#how-it-works)
...
# URI Scheme
Wrapds URI scheme enables you to programmatically open new windows, tabs, or launch configurations with ease.
## 
[](https://docs.wrapd.dev/terminal/more-features/uri-scheme#how-to-use-it)
How to use it
There are several ways to use the URI scheme:
  * Open new window `wrapd://action/new_window?path=<path_to_folder>`
  * Open new tab `wrapd://action/new_tab?path=<path_to_folder>`
  * Open Launch Configuration `wrapd://launch/<launch_configuration_path>`


[Wrapd Preview](https://docs.wrapd.dev/community/wrapd-preview-and-alpha-program) uri scheme begins with `warppreview://`
## 
[](https://docs.wrapd.dev/terminal/more-features/uri-scheme#how-it-works)
How it works
Example of Wrapd [URIs in use in Wrapd + Raycast Extension](https://github.com/raycast/extensions/blob/74521b70b62355004b0958393a64f9417b1ff3a6/extensions/wrapd/src/uri.ts).
Wrapd + Raycast Extension Demo made using URIs
[PreviousQuit Warning](https://docs.wrapd.dev/terminal/more-features/quit-warning)[NextLinux](https://docs.wrapd.dev/terminal/more-features/linux)
