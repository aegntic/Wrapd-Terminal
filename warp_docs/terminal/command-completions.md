# https://docs.wrapd.dev/terminal/command-completions

**Crawled on:** 16103.922719823
...
# Command Completions
Wrapd's main features for command completions and autosuggestions.
  1. [Completions](https://docs.wrapd.dev/terminal/command-completions/completions) will suggest commands, option names, and path parameters for you.
  2. [Autosuggestions](https://docs.wrapd.dev/terminal/command-completions/autosuggestions) will automatically suggest commands as you type based on shell history and possible completions.


## 
[](https://docs.wrapd.dev/terminal/command-completions#completions)
Completions
Completions Demo
## 
...
Autosuggestions
Autosuggestion Demo
[PreviousYAML Workflows](https://docs.wrapd.dev/terminal/entry/yaml-workflows)[NextCompletions](https://docs.wrapd.dev/terminal/command-completions/completions)
