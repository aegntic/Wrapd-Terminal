# https://docs.wrapd.dev/terminal/appearance

**Crawled on:** 15996.748084838
...
# Appearance
[Themes](https://docs.wrapd.dev/terminal/appearance/themes)[Custom Themes](https://docs.wrapd.dev/terminal/appearance/custom-themes)[Prompt](https://docs.wrapd.dev/terminal/appearance/prompt)[Input Position](https://docs.wrapd.dev/terminal/appearance/input-position)[Text, Fonts, & Cursor](https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor)[Size, Opacity, & Blurring](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring)[Pane Dimming & Focus](https://docs.wrapd.dev/terminal/appearance/pane-dimming)[Blocks Behavior](https://docs.wrapd.dev/terminal/appearance/blocks-behavior)[Tabs Behavior](https://docs.wrapd.dev/terminal/appearance/tabs-behavior)[App Icons](https://docs.wrapd.dev/terminal/appearance/app-icons)
[PreviousVoice](https://docs.wrapd.dev/aegnts/voice)[NextThemes](https://docs.wrapd.dev/terminal/appearance/themes)
