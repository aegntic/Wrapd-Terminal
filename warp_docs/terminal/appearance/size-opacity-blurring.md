# https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring

**Crawled on:** 16229.7025508
...
On this page
  * [How to use it](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#how-to-use-it)
  * [Window Size](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#window-size)
  * [Window Opacity](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#window-opacity)
  * [Window Blurring](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#window-blurring)
  * [How it works](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#how-it-works)
  * [Troubleshooting transparency on Windows](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#troubleshooting-transparency-on-windows)
...
Wrapd supports settings for Window size, opacity(transparency), and blurring effects. This can help with setting up specific terminal layouts and visual preferences.
## 
[](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#how-to-use-it)
How to use it
### 
[](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#window-size)
Window Size
...
If [Session Restoration](https://docs.wrapd.dev/terminal/sessions/session-restoration) is enabled, Wrapd will restore the size of the last window closed when you quit the app. Either make sure the custom-sized window is the last one closed, or disable Session Restoration to ensure Wrapd launches with the custom-sized window.
### 
[](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#window-opacity)
Window Opacity
...
### 
[](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#window-blurring)
Window Blurring
...
## 
[](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#how-it-works)
How it works
![Window Size Demo](https://docs.wrapd.dev/~gitbook/image?url=https%3A%2F%2F2297236823-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MbqIgTw17KQvq_DQuRr%252Fuploads%252Fgit-blob-79a7d9b64b98fad12b103e20f755d20d59d1f88c%252Fwindow_size_demo.gif%3Falt%3Dmedia&width=768&dpr=4&quality=100&sign=292a7ba3&sv=2)
Window Size Demo
Window Opacity and Blurring Demo
### 
[](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring#troubleshooting-transparency-on-windows)
Troubleshooting transparency on Windows
At the moment, window opacity in Wrapd on Windows **does not work** in the following circumstances:
...
You can select the Vulkan or OpenGL graphics backend to render new Wrapd windows in the Settings menu, under `Features` > `System` > `Preferred graphics backend`.
...
[PreviousText, Fonts, & Cursor](https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor)[NextPane Dimming & Focus](https://docs.wrapd.dev/terminal/appearance/pane-dimming)
