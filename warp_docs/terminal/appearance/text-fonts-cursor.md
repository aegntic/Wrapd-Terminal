# https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor

**Crawled on:** 16272.651286135
...
On this page
  * [How to use it](https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor#how-to-use-it)
  * [Text and Fonts](https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor#text-and-fonts)
  * [Cursor](https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor#cursor)
  * [How it works](https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor#how-it-works)
...
# Text, Fonts, & Cursor
Wrapd supports customizing the font and how text is displayed. This can help improve readability and usability. Wrapd also supports disabling the blinking cursor.
Once a new font is installed in your system, you need to restart Wrapd for it to show on the list of options. You may also need to check "View all available system fonts" to see the new font.
## 
[](https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor#how-to-use-it)
How to use it
### 
[](https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor#text-and-fonts)
Text and Fonts
...
On Linux, Wrapd does not support the "Use thin stroke" feature.
...
Enabling ligatures can reduce performance. Wrapds default font, Hack, doesn't yet have ligature support. We recommend font that supports ligatures (e.g. [Fira Code](https://github.com/tonsky/FiraCode)) as a stopgap.
### 
[](https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor#cursor)
Cursor
To access it, go to `Settings > Appearance > Cursor`
From there you can customize:
  * Select the Cursor type to Bar, Block, or Underline.
  * Toggle the Blinking cursor or from the [Command Palette](https://docs.wrapd.dev/terminal/command-palette), type "Cursor blink" and toggle the setting.


Cursor type preference is disabled while [Vim keybindings](https://docs.wrapd.dev/terminal/editor/vim) (vim mode) is active.
## 
[](https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor#how-it-works)
How it works
Text and Fonts DemoCursor Demo
[PreviousInput Position](https://docs.wrapd.dev/terminal/appearance/input-position)[NextSize, Opacity, & Blurring](https://docs.wrapd.dev/terminal/appearance/size-opacity-blurring)
