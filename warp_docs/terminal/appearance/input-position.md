# https://docs.wrapd.dev/terminal/appearance/input-position

**Crawled on:** 16269.277912822
...
On this page
  * [How to access it](https://docs.wrapd.dev/terminal/appearance/input-position#how-to-access-it)
  * [Related commands](https://docs.wrapd.dev/terminal/appearance/input-position#related-commands)
  * [How it works](https://docs.wrapd.dev/terminal/appearance/input-position#how-it-works)
...
# Input Position
Wrapd gives you the ability to configure the position of your input, which includes both the prompt and the command line.
...
Pin to the bottom (Wrapd mode)
Wrapd mode starts with input pinned to the bottom of your terminal view. Blocks of grouped input/output flow up and out of view. You can scroll up or navigate up to visit past commands.
## 
[](https://docs.wrapd.dev/terminal/appearance/input-position#how-to-access-it)
How to access it
  * You can configure your input position by navigating to `Settings > Appearance > Input`.
  * You can also choose and set modes from the [Command Palette](https://docs.wrapd.dev/terminal/command-palette).


Changes to the Input position take place immediately and apply to all open panes.
### 
[](https://docs.wrapd.dev/terminal/appearance/input-position#related-commands)
Related commands
macOS
[](https://docs.wrapd.dev/terminal/appearance/input-position#tab-macos)
Windows
[](https://docs.wrapd.dev/terminal/appearance/input-position#tab-windows)
Linux
[](https://docs.wrapd.dev/terminal/appearance/input-position#tab-linux)
...
## 
[](https://docs.wrapd.dev/terminal/appearance/input-position#how-it-works)
How it works
Input Position Demo
[PreviousPrompt](https://docs.wrapd.dev/terminal/appearance/prompt)[NextText, Fonts, & Cursor](https://docs.wrapd.dev/terminal/appearance/text-fonts-cursor)
