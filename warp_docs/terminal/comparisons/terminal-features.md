# https://docs.wrapd.dev/terminal/comparisons/terminal-features

**Crawled on:** 16000.713204291
...
# Terminal features
Below you'll find a table showcasing different terminal features (such as text attribution) and information about which one of those are supported in Wrapd.
...
[PreviousPerformance](https://docs.wrapd.dev/terminal/comparisons/performance)[NextIntegrations](https://docs.wrapd.dev/terminal/integrations-and-plugins)
