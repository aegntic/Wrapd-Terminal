# https://docs.wrapd.dev/terminal/blocks/background-blocks

**Crawled on:** 15326.577578087
...
On this page
  * [What is it](https://docs.wrapd.dev/terminal/blocks/background-blocks#what-is-it)
  * [How to use it](https://docs.wrapd.dev/terminal/blocks/background-blocks#how-to-use-it)
  * [How it works](https://docs.wrapd.dev/terminal/blocks/background-blocks#how-it-works)
  * [Troubleshooting Background Blocks](https://docs.wrapd.dev/terminal/blocks/background-blocks#troubleshooting-background-blocks)
...
## 
[](https://docs.wrapd.dev/terminal/blocks/background-blocks#what-is-it)
What is it
...
If Wrapd receives output that is likely from a background process, the output goes into a _background block_. Background blocks act like regular blocks, except that they don't have an associated command.
This lets you use all of Wrapd's block features with background output, such as sharing and bookmarking.
## 
[](https://docs.wrapd.dev/terminal/blocks/background-blocks#how-to-use-it)
How to use it
...
## 
[](https://docs.wrapd.dev/terminal/blocks/background-blocks#how-it-works)
How it works
Create Background Blocks
## 
[](https://docs.wrapd.dev/terminal/blocks/background-blocks#troubleshooting-background-blocks)
Troubleshooting Background Blocks
There are some limitations, because Wrapd doesn't know _which_ process any given output came from:
...
In addition, if you start entering a command while another one is running (typeahead), in some cases Wrapd will mistake the partial command for background output. The most common cause is editing typeahead when using bash versions older than 4.0 (for example, deleting and re-typing part of it).
[PreviousBlock Filtering](https://docs.wrapd.dev/terminal/blocks/block-filtering)[NextSticky Command Header](https://docs.wrapd.dev/terminal/blocks/sticky-command-header)
