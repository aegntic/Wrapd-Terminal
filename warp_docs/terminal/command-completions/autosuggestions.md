# https://docs.wrapd.dev/terminal/command-completions/autosuggestions

**Crawled on:** 16079.580285538
...
On this page
  * [How to access it](https://docs.wrapd.dev/terminal/command-completions/autosuggestions#how-to-access-it)
  * [How to use it](https://docs.wrapd.dev/terminal/command-completions/autosuggestions#how-to-use-it)
  * [How it works](https://docs.wrapd.dev/terminal/command-completions/autosuggestions#how-it-works)
...
# Autosuggestions
Wrapd will automatically suggest commands as you type based on shell history and possible completions.
## 
[](https://docs.wrapd.dev/terminal/command-completions/autosuggestions#how-to-access-it)
How to access it
  * From the [Command Palette](https://docs.wrapd.dev/terminal/command-palette), type in "Autosuggestions" to toggle.
...
## 
[](https://docs.wrapd.dev/terminal/command-completions/autosuggestions#how-to-use-it)
How to use it
macOS
[](https://docs.wrapd.dev/terminal/command-completions/autosuggestions#tab-macos)
Windows
[](https://docs.wrapd.dev/terminal/command-completions/autosuggestions#tab-windows)
Linux
[](https://docs.wrapd.dev/terminal/command-completions/autosuggestions#tab-linux)
...
## 
[](https://docs.wrapd.dev/terminal/command-completions/autosuggestions#how-it-works)
How it works
Autosuggestion Demo
[PreviousCompletions](https://docs.wrapd.dev/terminal/command-completions/completions)[NextCommand Palette](https://docs.wrapd.dev/terminal/command-palette)
