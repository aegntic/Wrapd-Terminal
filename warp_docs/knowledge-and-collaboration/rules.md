# https://docs.wrapd.dev/knowledge-and-collaboration/rules

**Crawled on:** 16136.748504753
...
On this page
  * [How to access Rules](https://docs.wrapd.dev/knowledge-and-collaboration/rules#how-to-access-rules)
  * [Managing Rules](https://docs.wrapd.dev/knowledge-and-collaboration/rules#managing-rules)
  * [Rules as Aegnt Mode context](https://docs.wrapd.dev/knowledge-and-collaboration/rules#rules-as-aegnt-mode-context)
  * [Rules Privacy](https://docs.wrapd.dev/knowledge-and-collaboration/rules#rules-privacy)
...
# Rules
Provide more context to your Aegnt Mode interactions.
Wrapd's Rules feature allows you to create and store rules that provide context to Aegnt Mode interations for smarter and more tailored assistance. Wrapd can also suggest rules to you based on your interactions with Aegnt Mode. These rules can include:
...
### 
[](https://docs.wrapd.dev/knowledge-and-collaboration/rules#how-to-access-rules)
How to access Rules
  * From the [Wrapd Drive](https://docs.wrapd.dev/knowledge-and-collaboration/wrapd-drive), > Personal > Rules
  * From the [Command Palette](https://docs.wrapd.dev/terminal/command-palette), search for "Open AI Rules"
  * From the Settings panel, `Settings > AI > Knowledge > Manage Rules`
  * From the macOS Menu, `AI > Open Rules`


### 
[](https://docs.wrapd.dev/knowledge-and-collaboration/rules#managing-rules)
Managing Rules
In the Rules pane, users can add, edit, delete any number of rules. Each rule includes a name (optional) and description.
Rules Demo
### 
[](https://docs.wrapd.dev/knowledge-and-collaboration/rules#rules-as-aegnt-mode-context)
Rules as Aegnt Mode context
Aegnt Mode can leverage the rules you created to tailor its responses. Rules that are pulled as context will be displayed in the conversation as a citation under "References" or "derived from".
![Context derived from memory](https://docs.wrapd.dev/~gitbook/image?url=https%3A%2F%2F2297236823-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MbqIgTw17KQvq_DQuRr%252Fuploads%252Fgit-blob-87a00de59467e7881853e667870d0e3f72d04fe8%252Fcontext-derived-from-memory.png%3Falt%3Dmedia&width=768&dpr=4&quality=100&sign=a08c749c&sv=2)
Derived from rules
![Context derived from memory](https://docs.wrapd.dev/~gitbook/image?url=https%3A%2F%2F2297236823-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MbqIgTw17KQvq_DQuRr%252Fuploads%252Fgit-blob-580cbe282a47aa93d4ee6e6b0063f003a1629aa1%252Fcontext-references-memory.png%3Falt%3Dmedia&width=768&dpr=4&quality=100&sign=bb66da66&sv=2)
Rules as references
### 
[](https://docs.wrapd.dev/knowledge-and-collaboration/rules#rules-privacy)
Rules Privacy
See our [Privacy Page](https://docs.wrapd.dev/privacy/privacy) for more information on how we handle data with Rules.
[PreviousModel Context Protocol](https://docs.wrapd.dev/knowledge-and-collaboration/mcp)[NextTeams](https://docs.wrapd.dev/knowledge-and-collaboration/teams)
