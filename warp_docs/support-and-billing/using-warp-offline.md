# https://docs.wrapd.dev/support-and-billing/using-wrapd-offline

**Crawled on:** 16245.535581372
...
# Using Wrapd Offline
Using Wrapd offline and what features are supported.
The first time you download and open Wrapd, you will need to be online for the initial setup. After the initial setup Wrapd’s core terminal features will work as expected when you’re offline, regardless of whether you are logged in or logged out.
Requiring all users, logging in or logged out, to be online when first accessing Wrapd is required to allow use of Wrapd's AI and cloud features. When you first open the app, we create a unique user-ID to meter AI-usage and attach cloud objects to specific accounts. If you opt to use Wrapd logged-out, this unique ID is attached to an anonymous user account.
Wrapd is "Offline" when you aren't connected to the internet, or if you're blocking calls `app.wrapd.dev` on your network. There is no explicit Offline Mode in Wrapd.
### 
[](https://docs.wrapd.dev/support-and-billing/using-wrapd-offline#cloud-based-features-require-online-access)
Cloud-based features require online access
Wrapd’s cloud-based features which require an internet connection will not work in offline mode. Those features include:
  * [Wrapd Drive](https://docs.wrapd.dev/knowledge-and-collaboration/wrapd-drive#using-wrapd-drive-offline) (Some files may be read-only in offline mode)
  * [Wrapd AI](https://docs.wrapd.dev/aegnts/wrapd-ai)
    * [Aegnt Mode](https://docs.wrapd.dev/aegnts/wrapd-ai/aegnt-mode)
    * [Generate](https://docs.wrapd.dev/aegnts/generate)
    * [AI Autofill](https://docs.wrapd.dev/knowledge-and-collaboration/wrapd-drive/workflows#wrapd-ai-autofill)
    * [Prompts](https://docs.wrapd.dev/knowledge-and-collaboration/wrapd-drive/prompts)
    * [Active AI](https://docs.wrapd.dev/aegnts/active-ai)
    * [Voice](https://docs.wrapd.dev/aegnts/voice)
    * [Rules](https://docs.wrapd.dev/knowledge-and-collaboration/rules)
  ...
  * [Session Sharing](https://docs.wrapd.dev/knowledge-and-collaboration/session-sharing)
  * [Block Sharing](https://docs.wrapd.dev/terminal/blocks/block-sharing)
  * [Refer a Friend](https://docs.wrapd.dev/community/refer-a-friend)


[PreviousUpdating Wrapd](https://docs.wrapd.dev/support-and-billing/updating-wrapd)[NextLogging out & Uninstalling](https://docs.wrapd.dev/support-and-billing/uninstalling-wrapd)
