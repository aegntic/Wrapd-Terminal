# https://docs.wrapd.dev/support-and-billing/updating-wrapd

**Crawled on:** 16034.643670993
...
# Updating Wrapd
Steps and help with updating Wrapd.
Wrapd automatically checks for updates on startup. A notification will appear in the top right corner of the Wrapd window when a new update is available.
![](https://docs.wrapd.dev/~gitbook/image?url=https%3A%2F%2F2297236823-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MbqIgTw17KQvq_DQuRr%252Fuploads%252Fgit-blob-976978f8711aaeb81d33778ed5c3a9d0a5820831%252Fupdate-available%2520%282%29%2520%281%29.png%3Falt%3Dmedia&width=768&dpr=4&quality=100&sign=e4f9680d&sv=2)
Update Available
To check for updates, search for "update" in the [Command Palette](https://docs.wrapd.dev/terminal/command-palette) or go to `Settings > Accounts` and click "Check for Update".
![](https://docs.wrapd.dev/~gitbook/image?url=https%3A%2F%2F2297236823-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MbqIgTw17KQvq_DQuRr%252Fuploads%252Fgit-blob-99ab35e6148db2f437666654403f1e91bcb92151%252Fcheck-for-update.gif%3Falt%3Dmedia&width=768&dpr=4&quality=100&sign=24720267&sv=2)
Check for Update manually
If nothing happens, it means you already have the latest stable build.
## 
[](https://docs.wrapd.dev/support-and-billing/updating-wrapd#auto-update-issues)
Auto-Update Issues
Wrapd cannot auto-update if it does not have the correct permissions to replace the running version of Wrapd If this is the case, a banner will prompt you to manually update Wrapd.
![](https://docs.wrapd.dev/~gitbook/image?url=https%3A%2F%2F2297236823-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MbqIgTw17KQvq_DQuRr%252Fuploads%252Fgit-blob-5b32279175fc86324225ee14a9eb1b38db1f8489%252Fimage.png%3Falt%3Dmedia%26token%3D3677f821-42b2-42a0-b341-2d78a573b5b6&width=768&dpr=4&quality=100&sign=761b0492&sv=2)
Update Available
There are 2 main causes of this:
  1. You opened Wrapd directly from the mounted volume instead of dragging it into your Applications directory. If this is the case, the easiest fix is to quit Wrapd, drag the application into /Applications, and restart Wrapd.
...
(Oct 2022): There is a known issue with [auto-update on MacOS Ventura](https://docs.wrapd.dev/support-and-billing/known-issues#auto-update-on-macos-ventura).
[PreviousPlans & Pricing](https://docs.wrapd.dev/support-and-billing/plans-and-pricing)[NextUsing Wrapd Offline](https://docs.wrapd.dev/support-and-billing/using-wrapd-offline)
