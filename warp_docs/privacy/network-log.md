# https://docs.wrapd.dev/privacy/network-log

**Crawled on:** 16197.960430829
...
On this page
  * [What is it](https://docs.wrapd.dev/privacy/network-log#what-is-it)
  * [How to use it](https://docs.wrapd.dev/privacy/network-log#how-to-use-it)
  * [How it Works](https://docs.wrapd.dev/privacy/network-log#how-it-works)
  * [Known Issues with Network Log](https://docs.wrapd.dev/privacy/network-log#known-issues-with-network-log)
...
## 
[](https://docs.wrapd.dev/privacy/network-log#what-is-it)
What is it
You can use Wrapd’s network log to help debug issues or simply use it to understand when information is sent or received over the network throughout a Wrapd terminal session.
Each log item is a timestamped Debug format string for either a request or response object handled by Wrapd. Messages are logged via pre-request and post-response hooks in Wrapd’s internal HTTP client.
## 
[](https://docs.wrapd.dev/privacy/network-log#how-to-use-it)
How to use it
  1. To access the network log, select the Input in a session and open the [Command Palette](https://docs.wrapd.dev/terminal/command-palette), then search for “Show Wrapd Network Log”.
...
## 
[](https://docs.wrapd.dev/privacy/network-log#how-it-works)
How it Works
Network Log Demo
## 
[](https://docs.wrapd.dev/privacy/network-log#known-issues-with-network-log)
Known Issues with Network Log
At the moment, network traffic originating from crash reports and error messages is not captured in the network log. This is due to our use of the Sentry SDK, which encapsulates all network logic and doesn’t currently expose a hook for handling requests and responses directly. The team is actively investigating a solution to include such traffic in the log in a future release. You may also disable Crash Reporting entirely in Wrapd’s `Settings > Privacy` tab.
[PreviousSecret Redaction](https://docs.wrapd.dev/privacy/secret-redaction)[NextRefer a Friend & Earn Rewards](https://docs.wrapd.dev/community/refer-a-friend)
